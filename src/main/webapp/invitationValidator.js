function validateForm() {
	...
	var locationInput = document.forms["invitationPage"]["location"].value;
	if (!locationInput) {
	...
	var descInput = document.forms["invitationPage"]["desc"].value;
	if (descInput == '') {
	...
	var nameInput = document.forms["invitationPage"]["eventname"].value;
	if (nameInput == '') {
	...
	var dateInput = document.forms["invitationPage"]["date"].value;
	if (!dateInput) {
